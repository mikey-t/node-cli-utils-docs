import { Task, NamedTask, TaskOrNamedTask } from './Swig.cjs';
 ...
 * ```
 */
export declare const series: (first: TaskOrNamedTask, ...rest: TaskOrNamedTask[]) => Task;
/**
 ...
 * ```
 */
export declare const parallel: (first: TaskOrNamedTask, ...rest: TaskOrNamedTask[]) => Task;
