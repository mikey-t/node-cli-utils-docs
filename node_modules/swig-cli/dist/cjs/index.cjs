...
var singletonManager_js_1 = require("./singletonManager.cjs");
/**
 ...
 * ```
 */
var series = function (first) {
    var rest = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        rest[_i - 1] = arguments[_i];
    }
    var innerSeries = function () { return __awaiter(void 0, void 0, void 0, function () {
        var swigInstance, instanceSeries;
        return __generator(this, function (_a) {
            swigInstance = (0, singletonManager_js_1.getSwigInstance)();
            instanceSeries = swigInstance.series.apply(swigInstance, __spreadArray([first], rest, false));
            return [2 /*return*/, instanceSeries()];
        });
    }); };
    return innerSeries;
};
 ...
 * ```
 */
var parallel = function (first) {
    var rest = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        rest[_i - 1] = arguments[_i];
    }
    var innerParallel = function () { return __awaiter(void 0, void 0, void 0, function () {
        var swigInstance, instanceParallel;
        return __generator(this, function (_a) {
            swigInstance = (0, singletonManager_js_1.getSwigInstance)();
            instanceParallel = swigInstance.parallel.apply(swigInstance, __spreadArray([first], rest, false));
            return [2 /*return*/, instanceParallel()];
        });
    }); };
